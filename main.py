...
# Финальная версия. Если интересует дальнейшее использование, рекомендации по рефакторингу --->>>
# --->>> Crypt/Decrypt - одна функция, независимая длина ключа, обработка исключений.